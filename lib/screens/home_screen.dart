        ...
        body: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: const Row(
                children: [
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text("제품에 이상 징후가 발견되면\n전문 상담사가 알려드려요.", style: TextStyle(fontWeight: FontWeight.bold)), SizedBox(height: 10), Chip(label: Text("지금 알아보기", style: TextStyle(color: kAccentBlue)), backgroundColor: Color(0xFFEEF1F8), side: BorderSide.none)])),
